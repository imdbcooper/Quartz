          ...
          {config.channels.map((ch) => (
            ...
            >
              <span class="contacts-channel__icon" aria-hidden="true">
                <svg
                  class="contacts-channel__icon-svg"
                  viewBox="0 0 24 24"
                  fill="none"
                  aria-hidden="true"
                >
                  {ch.icon === "send" && (
                    <>
                      <path
                        d="M21 4L3 11.53L10.2 13.93L12.6 21L21 4Z"
                        stroke="currentColor"
                        stroke-width="1.8"
              ...
              <span class="contacts-channel__arrow" aria-hidden="true">
                <svg
                  class="contacts-channel__arrow-svg"
                  viewBox="0 0 24 24"
                  fill="none"
                  aria-hidden="true"
                >
