    ...
    return (
      <section class="central-hero" aria-labelledby="central-hero-title">
        ...
        <div class="central-hero__content">
          <h2 id="central-hero-title">{config.title}</h2>
          <p class="central-hero__subtitle">{config.subtitle}</p>
          ...
          {config.secondaryAction && (
            <a class="central-hero__secondary" href={config.secondaryAction.href}>
